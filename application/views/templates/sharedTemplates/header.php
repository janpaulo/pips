...
<head>
    ...
    <title> PhilHealth Employees Attendance and Remuneration System</title>

    <!-- Google Font: Source Sans Pro -->
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo base_url();?>asset/css/form.css">
    ...
    <link
        href="<?php echo base_url();?>asset/bootstrap-5.0.2-dist/css/bootstrap.min.css?version=<?php echo rand(10,100); ?>"
	...
	<link href="<?php echo base_url();?>asset/sweetalert2/package/dist/sweetalert2.min.css" rel="stylesheet" type="text/css">
    <link
        href="<?php echo base_url();?>asset/DataTables-1.13.6/media/css/dataTables.bootstrap5.min.css?version=<?php echo rand(10,100); ?>"
        rel="stylesheet" type="text/css">
